...
public interface ISysUserTenantService extends IService<SysUserTenant> {
     ...
     * @return
     */
    List<String> getUserIdsByTenantId(Long tenantId);
     ...
     * @return
     */
    IPage<SysUserTenantVo> getUserTenantPageList(Page<SysUserTenantVo> page, List<String> status, SysUser user, Long tenantId);
     ...
     * @param tenantId
     */
    void putCancelQuit(List<String> userIds, Long tenantId);
     ...
     * @return
     */
    Integer userTenantIzExist(String userId, Long tenantId);
}
