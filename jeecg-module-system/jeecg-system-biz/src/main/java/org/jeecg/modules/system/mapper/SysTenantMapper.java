...
public interface SysTenantMapper extends BaseMapper<SysTenant> {
     ...
     * @return
     */
    List<TenantPackUserCount> queryTenantPackUserCount(@Param("tenantId") Long tenantId);
     ...
     * @return
     */
    Integer querySuperAdminCount(@Param("tenantId") Long tenantId, @Param("userId") String userId);
     ...
     * @return
     */
    List<String> queryUserPackCode(@Param("tenantId") Long tenantId, @Param("userId") String userId);
     ...
     * @return
     */
    List<TenantPackUser> queryPackUserList(@Param("tenantId") Long tenantId, @Param("packId") String packId, @Param("packUserStatus") Integer packUserStatus);
