...
public interface SysUserMapper extends BaseMapper<SysUser> {
	 ...
	 * @param orgCode
	 */
	void updateUserDepart(@Param("username") String username,@Param("orgCode") String orgCode, @Param("loginTenantId") Long loginTenantId);
	 ...
	 * @return
	 */
	IPage<SysUser> selectUserListByRoleId(Page<SysUser> page,  @Param("roleId") String roleId,  @Param("keyword") String keyword,  @Param("tenantId") Long tenantId);
	 ...
	 * @return
	 */
	List<SysUser> getTenantQuitList(@Param("tenantId") Long tenantId);
}
