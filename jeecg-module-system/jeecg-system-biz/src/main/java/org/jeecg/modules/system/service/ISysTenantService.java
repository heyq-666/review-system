...
public interface ISysTenantService extends IService<SysTenant> {
     ...
     * @param userId
     */
    Long saveTenantJoinUser(SysTenant sysTenant, String userId);
     ...
     * @param userId
     */
    Long joinTenantByHouseNumber(SysTenant sysTenant, String userId);
     ...
     * @return
     */
    TenantDepartAuthInfo getTenantDepartAuthInfo(Long tenantId);
     ...
     * @return
     */
    List<TenantPackUserCount> queryTenantPackUserCount(Long tenantId);
     ...
     * 查询申请的用户列表
     */
    List<TenantPackUser> getTenantPackApplyUsers(Long tenantId);
