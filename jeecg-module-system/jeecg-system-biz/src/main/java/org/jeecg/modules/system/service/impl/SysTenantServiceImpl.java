...
public class SysTenantServiceImpl extends ServiceImpl<SysTenantMapper, SysTenant> implements ISysTenantService {
    ...
    public void invitationUserJoin(String ids, String phone) {
        ...
        for (String id:idArray) {
            ...
            if(count == 0){
                ...
                relation.setTenantId(Long.valueOf(id));
    ...
    @Override
    @CacheEvict(value={CacheConstant.SYS_USERS_CACHE}, allEntries=true)
    public Long saveTenantJoinUser(SysTenant sysTenant, String userId) {
        //添加租户
    ...
    @Override
    @CacheEvict(value={CacheConstant.SYS_USERS_CACHE}, allEntries=true)
    public Long joinTenantByHouseNumber(SysTenant sysTenant, String userId) {
     ...
     */
    @CacheEvict(value={CacheConstant.SYS_USERS_CACHE}, allEntries=true)
    public Long saveTenantRelation(Long tenantId,String userId) {
        SysUserTenant relation = new SysUserTenant();
     ...
     * @return
     */
   public Long tenantIdGenerate(){
       synchronized (this){
           //获取最大值id
           long maxTenantId = tenantMapper.getMaxTenantId();
           if(maxTenantId >= 1000){
    ...
    @Override
    public TenantDepartAuthInfo getTenantDepartAuthInfo(Long tenantId) {
    ...
    @Override
    public List<TenantPackUserCount> queryTenantPackUserCount(Long tenantId) {
    ...
    @Override
    public List<TenantPackUser> getTenantPackApplyUsers(Long tenantId) {
     ...
     * @return
     */
    private List<TenantPackUser> getTenantPackUserList(Long tenantId, String packId, Integer packUserStatus){
        // 查询用户
...
//                }
     ...
     * @param tenantId
     */
    private void addUserProcess(SysUser user, LoginUser loginUser, Long tenantId) {
        LoginUser userInfo = new LoginUser();
        //触发入职流程
        BeanUtils.copyProperties(user, userInfo);
    }
